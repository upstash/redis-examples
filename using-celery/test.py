...
req1 = process_task.apply_async(('hard','id1', 'id1@a.a'), task_id='id1')
...
if res1['billable_time'] > 1 or res2['billable_time'] < 1 or res3['billable_time'] < 5 or res4['billable_time'] < 7 or res5['billable_time'] > 1:
