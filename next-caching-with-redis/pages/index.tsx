...
export default function Home() {
  ...
  return (
    <main className="text-center">
      <h1 className="text-4xl font-bold">Covid Tracker</h1>

      <p className="mt-4 text-xl">Top 10 countries with the most cases today</p>

      <div className="mt-16">
        <div className="" onClick={refresh}>
          <table className="m-auto table-fixed text-left">
            <thead>
          ...
          <br />
          <em>
            Loaded from {data.type} in <b>{data.latency}</b> milliseconds. Click
            to reload.
          </em>
        </div>
      </div>
